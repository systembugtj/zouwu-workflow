...
const siteData = deserializeFunctions(
    JSON.parse(
        '{"lang":"zh-CN","dir":"ltr","title":"Zouwu Workflow","description":"驺吾工作流 - 基于 Nx Monorepo 的工作流 Schema 定义和验证系统","base":"/zouwu-workflow/","head":[],"router":{"prefetchLinks":true},"appearance":true,"themeConfig":{"nav":[{"text":"首页","link":"/"},{"text":"规范文档","link":"/zouwu-workflow-specification-v1.0.md"},{"text":"包文档","items":[{"text":"核心包","link":"/packages/zouwu-workflow"},{"text":"CLI 工具","link":"/packages/zouwu-cli"},{"text":"表达式解析器","link":"/packages/zouwu-expression-parser"}]},{"text":"GitHub","link":"https://github.com/systembugtj/zouwu-workflow"}],"sidebar":{"/":[{"text":"介绍","items":[{"text":"项目概述","link":"/"},{"text":"快速开始","link":"/getting-started"}]},{"text":"规范文档","items":[{"text":"工作流规范 v1.0","link":"/zouwu-workflow-specification-v1.0.md"}]},{"text":"包文档","items":[{"text":"核心包 (zouwu-workflow)","link":"/packages/zouwu-workflow"},{"text":"CLI 工具 (zouwu-cli)","link":"/packages/zouwu-cli"},{"text":"表达式解析器 (zouwu-expression-parser)","link":"/packages/zouwu-expression-parser"}]}]},"socialLinks":[{"icon":"github","link":"https://github.com/systembugtj/zouwu-workflow"}],"footer":{"message":"Released under the MIT License.","copyright":"Copyright © 2024 Systembug"}},"locales":{},"scrollOffset":134,"cleanUrls":false}'
    )
);
...
function resolveSiteDataByRoute(siteData2, relativePath) {
    ...
    return Object.assign({}, siteData2, {
        ...
        title:
            ((_c = siteData2.locales[localeIndex]) == null ? void 0 : _c.title) ?? siteData2.title,
        titleTemplate:
            ((_d = siteData2.locales[localeIndex]) == null ? void 0 : _d.titleTemplate) ??
            siteData2.titleTemplate,
        description:
            ((_e = siteData2.locales[localeIndex]) == null ? void 0 : _e.description) ??
            siteData2.description,
        head: mergeHead(
            siteData2.head,
            ((_f = siteData2.locales[localeIndex]) == null ? void 0 : _f.head) ?? []
        ),
        themeConfig: {
    ...
    if (KNOWN_EXTENSIONS.size === 0) {
        const extraExts =
            (typeof process === 'object' &&
                ((_a = process.env) == null ? void 0 : _a.VITE_EXTRA_EXTENSIONS)) ||
            (__vite_import_meta_env__ == null
                ? void 0
                : __vite_import_meta_env__.VITE_EXTRA_EXTENSIONS) ||
            '';
        (
...
function pathToFile(path) {
    ...
    {
        if (inBrowser) {
            const base = '/zouwu-workflow/';
            pagePath =
                sanitizeFileName(pagePath.slice(base.length).replace(/\//g, '_') || 'index') +
                '.md';
...
function createRouter(loadPageModule, fallbackComponent) {
    ...
    async function go(href = inBrowser ? location.href : '/') {
        ...
        await loadPage(href);
        await ((_b = router.onAfterRouteChange ?? router.onAfterRouteChanged) == null
            ? void 0
            : _b(href));
    }
    ...
    async function loadPage(href, scrollPosition = 0, isRetry = false) {
        var _a, _b;
        if (
            (await ((_a = router.onBeforePageLoad) == null ? void 0 : _a.call(router, href))) ===
            false
        )
            return;
    ...
    if (inBrowser) {
        ...
        window.addEventListener(
            ...
            (e) => {
                ...
                if (
                    !link2 ||
                    link2.closest('.vp-raw') ||
                    link2.hasAttribute('download') ||
                    link2.hasAttribute('target')
                )
                    return;
                const linkHref =
                    link2.getAttribute('href') ??
                    (link2 instanceof SVGAElement ? link2.getAttribute('xlink:href') : null);
        ...
        window.addEventListener('popstate', async (e) => {
            ...
            await ((_a = router.onAfterRouteChange ?? router.onAfterRouteChanged) == null
                ? void 0
                : _a(href));
        });
...
const _sfc_main$13 = /* @__PURE__ */ defineComponent({
    ...
    setup(__props) {
        return (_ctx, _push, _parent, _attrs) => {
            if (__props.show) {
                _push(
                    `<div${ssrRenderAttrs(mergeProps({ class: 'VPBackdrop' }, _attrs))} data-v-c79a1216></div>`
                );
            } else {
                _push(`<!---->`);
            }
...
function resolveTitle(theme2) {
    return (
        (typeof theme2.outline === 'object' &&
            !Array.isArray(theme2.outline) &&
            theme2.outline.label) ||
        theme2.outlineTitle ||
        'On this page'
    );
}
    ...
    setup(__props) {
        return (_ctx, _push, _parent, _attrs) => {
            ...
            ssrRenderList(__props.headers, ({ children, link: link2, title }) => {
                _push(
                    `<li data-v-b933a997><a class="outline-link"${ssrRenderAttr('href', link2)}${ssrRenderAttr('title', title)} data-v-b933a997>${ssrInterpolate(title)}</a>`
                );
                if (children == null ? void 0 : children.length) {
                    _push(
                        ssrRenderComponent(
                            _component_VPDocOutlineItem,
                            { headers: children },
                            null,
                            _parent
                        )
...
const VPDocOutlineItem = /* @__PURE__ */ _export_sfc(_sfc_main$11, [
    ['__scopeId', 'data-v-b933a997'],
]);
    ...
    setup(__props) {
        ...
        return (_ctx, _push, _parent, _attrs) => {
            _push(
                ...
                )} data-v-a5bbad30><div class="content" data-v-a5bbad30><div class="outline-marker" data-v-a5bbad30></div><div aria-level="2" class="outline-title" id="doc-outline-aria-label" role="heading" data-v-a5bbad30>${ssrInterpolate(unref(resolveTitle)(unref(theme2)))}</div>`
            );
            _push(
                ssrRenderComponent(
                    VPDocOutlineItem,
...
const VPDocAsideOutline = /* @__PURE__ */ _export_sfc(_sfc_main$10, [
    ['__scopeId', 'data-v-a5bbad30'],
]);
...
const _sfc_main$_ = /* @__PURE__ */ defineComponent({
    ...
    setup(__props) {
        ...
        return (_ctx, _push, _parent, _attrs) => {
            _push(
                `<div${ssrRenderAttrs(mergeProps({ class: 'VPDocAside' }, _attrs))} data-v-3f215769>`
            );
...
function usePrevNext() {
    ...
    return computed(() => {
        ...
        const hidePrev =
            (((_a = theme2.value.docFooter) == null ? void 0 : _a.prev) === false &&
                !frontmatter.value.prev) ||
            frontmatter.value.prev === false;
        const hideNext =
            (((_b = theme2.value.docFooter) == null ? void 0 : _b.next) === false &&
...
const _sfc_main$Y = /* @__PURE__ */ defineComponent({
    ...
    setup(__props) {
        ...
        return (_ctx, _push, _parent, _attrs) => {
            var _a;
            _push(
                `<p${ssrRenderAttrs(mergeProps({ class: 'VPLastUpdated' }, _attrs))} data-v-e98dd255>${ssrInterpolate(((_a = unref(theme2).lastUpdated) == null ? void 0 : _a.text) || unref(theme2).lastUpdatedText || 'Last updated')}: <time${ssrRenderAttr('datetime', isoDatetime.value)} data-v-e98dd255>${ssrInterpolate(datetime.value)}</time></p>`
            );
        };
    },
});
...
const VPDocFooterLastUpdated = /* @__PURE__ */ _export_sfc(_sfc_main$Y, [
    ['__scopeId', 'data-v-e98dd255'],
]);
const _sfc_main$X = /* @__PURE__ */ defineComponent({
    ...
    setup(__props) {
        ...
        return (_ctx, _push, _parent, _attrs) => {
            ...
            if (showFooter.value) {
                _push(
                    `<footer${ssrRenderAttrs(mergeProps({ class: 'VPDocFooter' }, _attrs))} data-v-e257564d>`
                );
                            ...
                            ssrRenderComponent(
                                ...
                                },
                                {
                                    default: withCtx((_, _push2, _parent2, _scopeId) => {
                                        if (_push2) {
                                            _push2(
                                                `<span class="vpi-square-pen edit-link-icon" data-v-e257564d${_scopeId}></span> ${ssrInterpolate(unref(editLink).text)}`
                                            );
                                        } else {
                                            return [
                                                createVNode('span', {
                                                ...
                                                createTextVNode(
                                                    ' ' + toDisplayString(unref(editLink).text),
                                                    1
                                                ),
                                            ];
                                        }
                ...
                if (
                    ((_a = unref(control).prev) == null ? void 0 : _a.link) ||
                    ((_b = unref(control).next) == null ? void 0 : _b.link)
                ) {
                    _push(
                        `<nav class="prev-next" aria-labelledby="doc-footer-aria-label" data-v-e257564d><span class="visually-hidden" id="doc-footer-aria-label" data-v-e257564d>Pager</span><div class="pager" data-v-e257564d>`
                    );
                            ...
                            ssrRenderComponent(
                                ...
                                },
                                {
                                    default: withCtx((_, _push2, _parent2, _scopeId) => {
                                        ...
                                        if (_push2) {
                                            _push2(
                                                `<span class="desc" data-v-e257564d${_scopeId}>${(((_a2 = unref(theme2).docFooter) == null ? void 0 : _a2.prev) || 'Previous page') ?? ''}</span><span class="title" data-v-e257564d${_scopeId}>${unref(control).prev.text ?? ''}</span>`
                                            );
                                        } else {
                                            return [
                                                createVNode(
                                                    'span',
                                                    {
                                                        class: 'desc',
                                                        innerHTML:
                                                            ((_b2 = unref(theme2).docFooter) == null
                                                                ? void 0
                                                                : _b2.prev) || 'Previous page',
                                                    },
                                                    null,
                                                    8,
                                                    ['innerHTML']
                            ...
                            ssrRenderComponent(
                                ...
                                },
                                {
                                    default: withCtx((_, _push2, _parent2, _scopeId) => {
                                        ...
                                        if (_push2) {
                                            _push2(
                                                `<span class="desc" data-v-e257564d${_scopeId}>${(((_a2 = unref(theme2).docFooter) == null ? void 0 : _a2.next) || 'Next page') ?? ''}</span><span class="title" data-v-e257564d${_scopeId}>${unref(control).next.text ?? ''}</span>`
                                            );
                                        } else {
                                            return [
                                                createVNode(
...
const _sfc_main$W = /* @__PURE__ */ defineComponent({
    ...
    setup(__props) {
        ...
        return (_ctx, _push, _parent, _attrs) => {
                    ...
                    mergeProps(
                        {
                            class: [
                                'VPDoc',
                                { 'has-sidebar': unref(hasSidebar), 'has-aside': unref(hasAside) },
                            ],
                        },
                        _attrs
                    )
            ...
            if (unref(hasAside)) {
                _push(
                    `<div class="${ssrRenderClass([{ 'left-aside': unref(leftAside) }, 'aside'])}" data-v-39a288b8><div class="aside-curtain" data-v-39a288b8></div><div class="aside-container" data-v-39a288b8><div class="aside-content" data-v-39a288b8>`
                );
                _push(
                    ssrRenderComponent(
                        VPDocAside,
            ...
            _push(
                `<div class="content" data-v-39a288b8><div class="content-container" data-v-39a288b8>`
            );
                    ...
                    ),
                    {
                        default: withCtx((_, _push2, _parent2, _scopeId) => {
                            if (_push2) {
                                ...
                                return [createTextVNode(toDisplayString(__props.text), 1)];
                            }
                        }),
                        _: 1,
                    }
                ...
                if (typeof __props.image === 'string' || 'src' in __props.image) {
                    _push(
                        `<img${ssrRenderAttrs(
                            mergeProps(
                                { class: 'VPImage' },
                                typeof __props.image === 'string'
                                    ? _ctx.$attrs
                                    : { ...__props.image, ..._ctx.$attrs },
                                {
                                    src: unref(withBase)(
                                        typeof __props.image === 'string'
                                            ? __props.image
        ...
        return (_ctx, _push, _parent, _attrs) => {
                    ...
                    mergeProps(
                        {
                            class: [
                                'VPHero',
                                { 'has-image': __props.image || unref(heroImageSlotExists) },
                            ],
                        },
                        _attrs
                    )
                )} data-v-4f9c455b><div class="container" data-v-4f9c455b><div class="main" data-v-4f9c455b>`
            );
            ...
            ssrRenderSlot(
                ...
                () => {
                    ...
                    if (__props.name) {
                        _push(
                            `<span class="name clip" data-v-4f9c455b>${__props.name ?? ''}</span>`
                        );
                    } else {
                        _push(`<!---->`);
                    }
            ...
            if (__props.image || unref(heroImageSlotExists)) {
                _push(
                    `<div class="image" data-v-4f9c455b><div class="image-container" data-v-4f9c455b><div class="image-bg" data-v-4f9c455b></div>`
                );
                ssrRenderSlot(
                    _ctx.$slots,
                    'home-hero-image',
                        ...
                        default: withCtx((_, _push2, _parent2, _scopeId) => {
                            if (_push2) {
                                ...
                                if (typeof __props.icon === 'object' && __props.icon.wrap) {
                                    ...
                                    _push2(
                                        `<div class="icon" data-v-a3976bdc${_scopeId}>${__props.icon ?? ''}</div>`
                                    );
                                } else {
                                    _push2(`<!---->`);
                                }
                                _push2(
                                    `<h2 class="title" data-v-a3976bdc${_scopeId}>${__props.title ?? ''}</h2>`
                                );
                                if (__props.details) {
                                    _push2(
                                        `<p class="details" data-v-a3976bdc${_scopeId}>${__props.details ?? ''}</p>`
                                    );
                                } else {
                                    _push2(`<!---->`);
                                }
                                if (__props.linkText) {
                                    _push2(
                                        `<div class="link-text" data-v-a3976bdc${_scopeId}><p class="link-text-value" data-v-a3976bdc${_scopeId}>${ssrInterpolate(__props.linkText)} <span class="vpi-arrow-right link-text-icon" data-v-a3976bdc${_scopeId}></span></p></div>`
                                    );
                                } else {
                                    _push2(`<!---->`);
                                }
                                ...
                                return [
                                    createVNode('article', { class: 'box' }, [
                                        typeof __props.icon === 'object' && __props.icon.wrap
                                            ? (openBlock(),
                                              createBlock(
                                                  'div',
                                                  {
...
const _sfc_main$Q = /* @__PURE__ */ defineComponent({
    ...
    setup(__props) {
        ...
        return (_ctx, _push, _parent, _attrs) => {
            if (__props.features) {
                _push(
                    `<div${ssrRenderAttrs(mergeProps({ class: 'VPFeatures' }, _attrs))} data-v-a6181336><div class="container" data-v-a6181336><div class="items" data-v-a6181336><!--[-->`
                );
                ssrRenderList(__props.features, (feature) => {
                    _push(
                        `<div class="${ssrRenderClass([[grid.value], 'item'])}" data-v-a6181336>`
                    );
                    _push(
                        ssrRenderComponent(
                            VPFeature,
    ...
    setup(__props) {
        ...
        return (_ctx, _push, _parent, _attrs) => {
            ...
            if (unref(page).isNotFound) {
                ...
                ssrRenderVNode(
                    _push,
                    createVNode(resolveDynamicComponent(unref(frontmatter).layout), null, null),
                    _parent
                );
            } else {
                _push(
        ...
        return (_ctx, _push, _parent, _attrs) => {
            if (unref(theme2).footer && unref(frontmatter).footer !== false) {
                _push(
                    ...
                    )} data-v-e315a0ad><div class="container" data-v-e315a0ad>`
                );
                if (unref(theme2).footer.message) {
                    _push(
                        `<p class="message" data-v-e315a0ad>${unref(theme2).footer.message ?? ''}</p>`
                    );
                } else {
                    _push(`<!---->`);
                }
                if (unref(theme2).footer.copyright) {
                    _push(
                        `<p class="copyright" data-v-e315a0ad>${unref(theme2).footer.copyright ?? ''}</p>`
                    );
                } else {
                    _push(`<!---->`);
                }
    ...
    setup(__props) {
        ...
        return (_ctx, _push, _parent, _attrs) => {
            ...
            if (__props.headers.length > 0) {
                _push(
                    `<button class="${ssrRenderClass({ open: open.value })}" data-v-8a42e2b4><span class="menu-text" data-v-8a42e2b4>${ssrInterpolate(unref(resolveTitle)(unref(theme2)))}</span><span class="vpi-chevron-right icon" data-v-8a42e2b4></span></button>`
                );
            } else {
                _push(
                    `<button data-v-8a42e2b4>${ssrInterpolate(unref(theme2).returnToTopLabel || 'Return to top')}</button>`
                );
            }
            if (open.value) {
                _push(
                    `<div class="items" data-v-8a42e2b4><div class="header" data-v-8a42e2b4><a class="top-link" href="#" data-v-8a42e2b4>${ssrInterpolate(unref(theme2).returnToTopLabel || 'Return to top')}</a></div><div class="outline" data-v-8a42e2b4>`
                );
                _push(
                    ssrRenderComponent(
                        VPDocOutlineItem,
...
const VPLocalNavOutlineDropdown = /* @__PURE__ */ _export_sfc(_sfc_main$J, [
    ['__scopeId', 'data-v-8a42e2b4'],
]);
const _sfc_main$I = /* @__PURE__ */ defineComponent({
    ...
    setup(__props) {
        ...
        return (_ctx, _push, _parent, _attrs) => {
            if (
                unref(frontmatter).layout !== 'home' &&
                (!emptyAndNoSidebar.value || unref(y) >= navHeight.value)
            ) {
                _push(
                    `<div${ssrRenderAttrs(mergeProps({ class: classes.value }, _attrs))} data-v-a6f0e41e><div class="container" data-v-a6f0e41e>`
                );
                if (unref(hasSidebar)) {
                    _push(
                        `<button class="menu"${ssrRenderAttr('aria-expanded', __props.open)} aria-controls="VPSidebarNav" data-v-a6f0e41e><span class="vpi-align-left menu-icon" data-v-a6f0e41e></span><span class="menu-text" data-v-a6f0e41e>${ssrInterpolate(unref(theme2).sidebarMenuLabel || 'Menu')}</span></button>`
                    );
                } else {
                    _push(`<!---->`);
                }
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
    _push(
        ...
        )} data-v-1d5665e3><span class="check" data-v-1d5665e3>`
    );
...
const VPSwitch = /* @__PURE__ */ _export_sfc(_sfc_main$H, [
                ...
                ssrRenderComponent(
                    ...
                    ),
                    {
                        default: withCtx((_, _push2, _parent2, _scopeId) => {
                            if (_push2) {
                                _push2(
                                    `<span class="vpi-sun sun" data-v-5337faa4${_scopeId}></span><span class="vpi-moon moon" data-v-5337faa4${_scopeId}></span>`
                                );
                            } else {
                                return [
...
const VPSwitchAppearance = /* @__PURE__ */ _export_sfc(_sfc_main$G, [
    ['__scopeId', 'data-v-5337faa4'],
]);
    ...
    setup(__props) {
        ...
        return (_ctx, _push, _parent, _attrs) => {
            if (
                ...
                _push(
                    `<div${ssrRenderAttrs(mergeProps({ class: 'VPNavBarAppearance' }, _attrs))} data-v-6c893767>`
                );
...
const VPNavBarAppearance = /* @__PURE__ */ _export_sfc(_sfc_main$F, [
    ['__scopeId', 'data-v-6c893767'],
]);
...
function useFlyout(options) {
    ...
    if (inBrowser) {
        ...
        const unwatch = watch(focusedElement, (el) => {
            ...
            if (
                el === options.el.value ||
                ((_a = options.el.value) == null ? void 0 : _a.contains(el))
            ) {
                focus.value = true;
...
const _sfc_main$E = /* @__PURE__ */ defineComponent({
    ...
    setup(__props) {
        ...
        return (_ctx, _push, _parent, _attrs) => {
            _push(
                `<div${ssrRenderAttrs(mergeProps({ class: 'VPMenuLink' }, _attrs))} data-v-35975db6>`
            );
            _push(
                ssrRenderComponent(
                    _sfc_main$Z,
                    ...
                    },
                    {
                        default: withCtx((_, _push2, _parent2, _scopeId) => {
                            if (_push2) {
                                _push2(
                                    `<span data-v-35975db6${_scopeId}>${__props.item.text ?? ''}</span>`
                                );
                            } else {
                                return [
                                    createVNode(
...
const _sfc_main$D = /* @__PURE__ */ defineComponent({
    ...
    setup(__props) {
        return (_ctx, _push, _parent, _attrs) => {
            _push(
                `<div${ssrRenderAttrs(mergeProps({ class: 'VPMenuGroup' }, _attrs))} data-v-69e747b5>`
            );
            if (__props.text) {
...
const _sfc_main$C = /* @__PURE__ */ defineComponent({
    ...
    setup(__props) {
        return (_ctx, _push, _parent, _attrs) => {
            _push(
                `<div${ssrRenderAttrs(mergeProps({ class: 'VPMenu' }, _attrs))} data-v-b98bc113>`
            );
            if (__props.items) {
                    ...
                    if ('link' in item) {
                        ...
                        ssrRenderVNode(
                            ...
                            createVNode(
                                ...
                                mergeProps({ ref_for: true }, item.props),
                                null
                            ),
                            _parent
                        );
    ...
    setup(__props) {
        ...
        return (_ctx, _push, _parent, _attrs) => {
            _push(
                ...
                )} data-v-cf11d7a2><button type="button" class="button" aria-haspopup="true"${ssrRenderAttr('aria-expanded', open.value)}${ssrRenderAttr('aria-label', __props.label)} data-v-cf11d7a2>`
            );
            if (__props.button || __props.icon) {
                _push(`<span class="text" data-v-cf11d7a2>`);
                if (__props.icon) {
                    _push(
                        `<span class="${ssrRenderClass([__props.icon, 'option-icon'])}" data-v-cf11d7a2></span>`
                    );
                } else {
                    _push(`<!---->`);
                }
    ...
    setup(__props) {
        ...
        onMounted(async () => {
            ...
            if (
                ...
                (getComputedStyle(span).maskImage || getComputedStyle(span).webkitMaskImage) ===
                    'none'
            ) {
        ...
        });
        {
            typeof props.icon === 'string' &&
                ((_a = useSSRContext()) == null ? void 0 : _a.vpSocialIcons.add(props.icon));
        }
        return (_ctx, _push, _parent, _attrs) => {
            _push(
                `<a${ssrRenderAttrs(
                    mergeProps(
                        {
                            ...
                            'aria-label':
                                __props.ariaLabel ??
                                (typeof __props.icon === 'string' ? __props.icon : ''),
                            target: '_blank',
                            rel: 'noopener',
                        },
                        _attrs
                    )
                )} data-v-bd121fe5>${svg.value ?? ''}</a>`
            );
        };
    },
});
...
const _sfc_main$z = /* @__PURE__ */ defineComponent({
    ...
    setup(__props) {
        return (_ctx, _push, _parent, _attrs) => {
            _push(
                `<div${ssrRenderAttrs(mergeProps({ class: 'VPSocialLinks' }, _attrs))} data-v-7bc22406><!--[-->`
            );
                            ...
                            default: withCtx((_, _push2, _parent2, _scopeId) => {
                                if (_push2) {
                                    if (unref(localeLinks).length && unref(currentLang).label) {
                                        _push2(
                                            `<div class="group translations" data-v-bb2aa2f0${_scopeId}><p class="trans-title" data-v-bb2aa2f0${_scopeId}>${ssrInterpolate(unref(currentLang).label)}</p><!--[-->`
                                        );
                                    ...
                                    if (
                                        ...
                                        _push2(
                                            `<div class="group" data-v-bb2aa2f0${_scopeId}><div class="item appearance" data-v-bb2aa2f0${_scopeId}><p class="label" data-v-bb2aa2f0${_scopeId}>${ssrInterpolate(unref(theme2).darkModeSwitchLabel || 'Appearance')}</p><div class="appearance-action" data-v-bb2aa2f0${_scopeId}>`
                                        );
                                        _push2(
                                            ssrRenderComponent(
                                                VPSwitchAppearance,
                                    ...
                                    if (unref(theme2).socialLinks) {
                                        _push2(
                                            `<div class="group" data-v-bb2aa2f0${_scopeId}><div class="item social-links" data-v-bb2aa2f0${_scopeId}>`
                                        );
                                        _push2(
                                            ssrRenderComponent(
                                                VPSocialLinks,
                                              ...
                                              createBlock(
                                                  ...
                                                  [
                                                      createVNode(
                                                          'p',
                                                          { class: 'trans-title' },
                                                          toDisplayString(unref(currentLang).label),
                                                          1
                                                      ),
                                                      (openBlock(true),
                                                      createBlock(
...
const VPNavBarHamburger = /* @__PURE__ */ _export_sfc(_sfc_main$x, [
    ['__scopeId', 'data-v-e5dd9c1c'],
]);
const _sfc_main$w = /* @__PURE__ */ defineComponent({
                ...
                ssrRenderComponent(
                    ...
                    ),
                    {
                        default: withCtx((_, _push2, _parent2, _scopeId) => {
                            if (_push2) {
                                _push2(
                                    `<span data-v-e56f3d57${_scopeId}>${__props.item.text ?? ''}</span>`
                                );
                            } else {
                                return [
                                    createVNode(
...
const VPNavBarMenuLink = /* @__PURE__ */ _export_sfc(_sfc_main$w, [
    ['__scopeId', 'data-v-e56f3d57'],
]);
const _sfc_main$v = /* @__PURE__ */ defineComponent({
        ...
        return (_ctx, _push, _parent, _attrs) => {
            if (unref(theme2).nav) {
                _push(
                    ...
                    )} data-v-dc692963><span id="main-nav-aria-label" class="visually-hidden" data-v-dc692963> Main Navigation </span><!--[-->`
                );
...
function createSearchTranslate(defaultTranslations) {
    ...
    function translate(key) {
        ...
        const locales =
            (isObject &&
                ((_c = (_b = themeObject.locales) == null ? void 0 : _b[localeIndex.value]) == null
                    ? void 0
                    : _c.translations)) ||
            null;
                ...
                if (loaded.value) {
                    _push(
                        ssrRenderComponent(
                            ...
                            {
                                algolia:
                                    ((_a = unref(theme2).search) == null ? void 0 : _a.options) ??
                                    unref(theme2).algolia,
...
const VPNavBarSocialLinks = /* @__PURE__ */ _export_sfc(_sfc_main$r, [
    ['__scopeId', 'data-v-0394ad82'],
]);
const _sfc_main$q = /* @__PURE__ */ defineComponent({
    ...
    setup(__props) {
        ...
        return (_ctx, _push, _parent, _attrs) => {
            _push(
                ...
                )} data-v-1168a8e4><a class="title"${ssrRenderAttr('href', link2.value ?? unref(normalizeLink$1)(unref(currentLang).link))}${ssrRenderAttr('rel', rel.value)}${ssrRenderAttr('target', target.value)} data-v-1168a8e4>`
            );
                    ...
                    ssrRenderComponent(
                        ...
                        ),
                        {
                            default: withCtx((_, _push2, _parent2, _scopeId) => {
                                if (_push2) {
                                    _push2(
                                        `<div class="items" data-v-88af2de4${_scopeId}><p class="title" data-v-88af2de4${_scopeId}>${ssrInterpolate(unref(currentLang).label)}</p><!--[-->`
                                    );
                                    ssrRenderList(unref(localeLinks), (locale) => {
                                        _push2(
                                            ssrRenderComponent(
...
const VPNavBarTranslations = /* @__PURE__ */ _export_sfc(_sfc_main$p, [
    ['__scopeId', 'data-v-88af2de4'],
]);
const _sfc_main$o = /* @__PURE__ */ defineComponent({
    __name: 'VPNavBar',
    __ssrInlineRender: true,
    ...
    setup(__props) {
        ...
        return (_ctx, _push, _parent, _attrs) => {
            _push(
                ...
                )} data-v-6aa21345><div class="wrapper" data-v-6aa21345><div class="container" data-v-6aa21345><div class="title" data-v-6aa21345>`
            );
            _push(
                ssrRenderComponent(
                    VPNavBarTitle,
            ...
            _push(
                `</div><div class="content" data-v-6aa21345><div class="content-body" data-v-6aa21345>`
            );
            ...
            _push(
                ssrRenderComponent(VPNavBarTranslations, { class: 'translations' }, null, _parent)
            );
            _push(ssrRenderComponent(VPNavBarAppearance, { class: 'appearance' }, null, _parent));
            _push(
                ssrRenderComponent(VPNavBarSocialLinks, { class: 'social-links' }, null, _parent)
            );
            ...
            _push(
                `</div></div></div></div><div class="divider" data-v-6aa21345><div class="divider-line" data-v-6aa21345></div></div></div>`
            );
        };
    },
});
    ...
    setup(__props) {
        ...
        return (_ctx, _push, _parent, _attrs) => {
            if (
                ...
                _push(
                    `<div${ssrRenderAttrs(mergeProps({ class: 'VPNavScreenAppearance' }, _attrs))} data-v-b44890b2><p class="text" data-v-b44890b2>${ssrInterpolate(unref(theme2).darkModeSwitchLabel || 'Appearance')}</p>`
                );
                _push(ssrRenderComponent(VPSwitchAppearance, null, null, _parent));
                _push(`</div>`);
            } else {
...
const VPNavScreenAppearance = /* @__PURE__ */ _export_sfc(_sfc_main$n, [
    ['__scopeId', 'data-v-b44890b2'],
]);
                ...
                ssrRenderComponent(
                    ...
                    ),
                    {
                        default: withCtx((_, _push2, _parent2, _scopeId) => {
                            if (_push2) {
                                _push2(
                                    `<span data-v-df37e6dd${_scopeId}>${__props.item.text ?? ''}</span>`
                                );
                            } else {
                                return [
                                    createVNode(
...
const VPNavScreenMenuLink = /* @__PURE__ */ _export_sfc(_sfc_main$m, [
    ['__scopeId', 'data-v-df37e6dd'],
]);
const _sfc_main$l = /* @__PURE__ */ defineComponent({
                ...
                ssrRenderComponent(
                    ...
                    ),
                    {
                        default: withCtx((_, _push2, _parent2, _scopeId) => {
                            if (_push2) {
                                _push2(
                                    `<span data-v-3e9c20e4${_scopeId}>${__props.item.text ?? ''}</span>`
                                );
                            } else {
                                return [
                                    createVNode(
...
const VPNavScreenMenuGroupLink = /* @__PURE__ */ _export_sfc(_sfc_main$l, [
    ['__scopeId', 'data-v-3e9c20e4'],
]);
const _sfc_main$k = /* @__PURE__ */ defineComponent({
    ...
    setup(__props) {
        return (_ctx, _push, _parent, _attrs) => {
            _push(
                `<div${ssrRenderAttrs(mergeProps({ class: 'VPNavScreenMenuGroupSection' }, _attrs))} data-v-8133b170>`
            );
            if (__props.text) {
...
_sfc_main$k.setup = (props, ctx) => {
    const ssrContext = useSSRContext();
    (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add(
        '../node_modules/vitepress/dist/client/theme-default/components/VPNavScreenMenuGroupSection.vue'
    );
    return _sfc_setup$k ? _sfc_setup$k(props, ctx) : void 0;
};
const VPNavScreenMenuGroupSection = /* @__PURE__ */ _export_sfc(_sfc_main$k, [
    ['__scopeId', 'data-v-8133b170'],
]);
const _sfc_main$j = /* @__PURE__ */ defineComponent({
...
const VPNavScreenMenuGroup = /* @__PURE__ */ _export_sfc(_sfc_main$j, [
    ['__scopeId', 'data-v-b9ab8c58'],
]);
const _sfc_main$i = /* @__PURE__ */ defineComponent({
    ...
    setup(__props) {
        ...
        return (_ctx, _push, _parent, _attrs) => {
            if (unref(theme2).nav) {
                _push(
                    `<nav${ssrRenderAttrs(mergeProps({ class: 'VPNavScreenMenu' }, _attrs))}><!--[-->`
                );
                ssrRenderList(unref(theme2).nav, (item) => {
                    _push(`<!--[-->`);
                    if ('link' in item) {
        ...
        return (_ctx, _push, _parent, _attrs) => {
            if (unref(localeLinks).length && unref(currentLang).label) {
                _push(
                    ...
                    )} data-v-858fe1a4><button class="title" data-v-858fe1a4><span class="vpi-languages icon lang" data-v-858fe1a4></span> ${ssrInterpolate(unref(currentLang).label)} <span class="vpi-chevron-down icon chevron" data-v-858fe1a4></span></button><ul class="list" data-v-858fe1a4><!--[-->`
                );
                ssrRenderList(unref(localeLinks), (locale) => {
...
const VPNavScreenTranslations = /* @__PURE__ */ _export_sfc(_sfc_main$g, [
    ['__scopeId', 'data-v-858fe1a4'],
]);
const _sfc_main$f = /* @__PURE__ */ defineComponent({
    __name: 'VPNavScreen',
    __ssrInlineRender: true,
        ...
        return (_ctx, _push, _parent, _attrs) => {
            if (__props.open) {
                _push(
                    ...
                    )} data-v-f2779853><div class="container" data-v-f2779853>`
                );
...
const _sfc_main$e = /* @__PURE__ */ defineComponent({
    ...
    setup(__props) {
        ...
        return (_ctx, _push, _parent, _attrs) => {
            if (hasNavbar.value) {
                _push(
                    `<header${ssrRenderAttrs(mergeProps({ class: 'VPNav' }, _attrs))} data-v-ae24b3ad>`
                );
                _push(
                    ssrRenderComponent(
                        VPNavBar,
                        ...
                        default: withCtx((_, _push2, _parent2, _scopeId) => {
                            if (_push2) {
                                if (__props.item.text) {
                                    _push2(
                                        `<div class="item"${ssrRenderAttr('role', itemRole.value)}${ssrRenderAttr('tabindex', __props.item.items && 0)} data-v-b3fd67f8${_scopeId}><div class="indicator" data-v-b3fd67f8${_scopeId}></div>`
                                    );
                                    ...
                                    if (
                                        __props.item.collapsed != null &&
                                        __props.item.items &&
                                        __props.item.items.length
                                    ) {
                                        _push2(
                                            `<div class="caret" role="button" aria-label="toggle section" tabindex="0" data-v-b3fd67f8${_scopeId}><span class="vpi-chevron-right caret-icon" data-v-b3fd67f8${_scopeId}></span></div>`
                                        );
                                    } else {
                                        _push2(`<!---->`);
                                    }
                                ...
                                return [
                                    __props.item.text
                                                      ...
                                                      ? (openBlock(),
                                                        createBlock(
                                                            'div',
                                                            {
                                                                ...
                                                                onKeydown: withKeys(onCaretClick, [
                                                                    'enter',
                                                                ]),
                                                                tabindex: '0',
                                                            },
                                        ...
                                        : createCommentVNode('', true),
                                    __props.item.items && __props.item.items.length
                                        ? (openBlock(),
                                          createBlock(
                                              'div',
                                              {
                                                  ...
                                                  __props.depth < 5
                                                      ? (openBlock(true),
                                                        createBlock(
                                                            Fragment,
                                                            { key: 0 },
                                                            renderList(__props.item.items, (i) => {
                                                                return (
                                                                    openBlock(),
                                                                    createBlock(
                                                                        _component_VPSidebarItem,
...
const _sfc_main$c = /* @__PURE__ */ defineComponent({
    ...
    setup(__props) {
        ...
        return (_ctx, _push, _parent, _attrs) => {
            ...
            ssrRenderList(__props.items, (item) => {
                _push(
                    `<div class="${ssrRenderClass([{ 'no-transition': disableTransition.value }, 'group'])}" data-v-c40bc020>`
                );
                _push(
                    ssrRenderComponent(
                        VPSidebarItem,
...
_sfc_main$c.setup = (props, ctx) => {
    const ssrContext = useSSRContext();
    (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add(
        '../node_modules/vitepress/dist/client/theme-default/components/VPSidebarGroup.vue'
    );
    return _sfc_setup$c ? _sfc_setup$c(props, ctx) : void 0;
};
        ...
        return (_ctx, _push, _parent, _attrs) => {
            if (unref(hasSidebar)) {
                _push(
                    ...
                    )} data-v-319d5ca6><div class="curtain" data-v-319d5ca6></div><nav class="nav" id="VPSidebarNav" aria-labelledby="sidebar-aria-label" tabindex="-1" data-v-319d5ca6><span class="visually-hidden" id="sidebar-aria-label" data-v-319d5ca6> Sidebar Navigation </span>`
                );
...
const _sfc_main$a = /* @__PURE__ */ defineComponent({
    ...
    setup(__props) {
        ...
        return (_ctx, _push, _parent, _attrs) => {
            _push(
                `<!--[--><span tabindex="-1" data-v-0b0ada53></span><a href="#VPContent" class="VPSkipLink visually-hidden" data-v-0b0ada53>${ssrInterpolate(unref(theme2).skipToContentLabel || 'Skip to content')}</a><!--]-->`
            );
        };
    },
});
...
const _sfc_main$5 = /* @__PURE__ */ defineComponent({
    ...
    setup(__props) {
        return (_ctx, _push, _parent, _attrs) => {
            _push(
                `<section${ssrRenderAttrs(mergeProps({ class: 'VPHomeSponsors' }, _attrs))} data-v-3d121b4a><div class="container" data-v-3d121b4a><div class="header" data-v-3d121b4a><div class="love" data-v-3d121b4a><span class="vpi-heart icon" data-v-3d121b4a></span></div>`
            );
            if (__props.message) {
                _push(
                    `<h2 class="message" data-v-3d121b4a>${ssrInterpolate(__props.message)}</h2>`
                );
            } else {
                _push(`<!---->`);
            }
                    ...
                    ssrRenderComponent(
                        ...
                        },
                        {
                            default: withCtx((_, _push2, _parent2, _scopeId) => {
                                if (_push2) {
                                    _push2(
                                        `<span class="vpi-heart sp-icon" data-v-f3fa364a${_scopeId}></span> ${ssrInterpolate(__props.member.actionText || 'Sponsor')}`
                                    );
                                } else {
                                    return [
...
const VPTeamMembersItem = /* @__PURE__ */ _export_sfc(_sfc_main$4, [
    ['__scopeId', 'data-v-f3fa364a'],
]);
    ...
    setup(__props) {
        ...
        return (_ctx, _push, _parent, _attrs) => {
            _push(
                ...
                )} data-v-6cb0dbc4><div class="container" data-v-6cb0dbc4><!--[-->`
            );
    ...
    if (inBrowser) {
        ...
        window.addEventListener('click', (e) => {
            ...
            if (el.matches('div[class*="language-"] > button.copy')) {
                ...
                const sibling =
                    (_a = el.nextElementSibling) == null ? void 0 : _a.nextElementSibling;
                if (!parent || !sibling) {
                    return;
                }
    ...
    const updateHeadTags = (newTags) => {
        ...
        managedHeadElements.forEach((oldEl, oldIndex) => {
            const matchedIndex = newElements.findIndex((newEl) =>
                newEl == null ? void 0 : newEl.isEqualNode(oldEl ?? null)
            );
            if (matchedIndex !== -1) {
